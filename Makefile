...
$(EXE): $(EXE).o context_manager.o shader_program.o mesh.o texture.o camera.o object_renderer.o obj_loader.o stb_image.o material.o
	g++ -o $@ $^ $(CFLAGS) $(LIBS)
...
object_renderer.o: object_renderer.cpp object_renderer.hpp mesh.hpp texture.hpp shader_program.hpp camera.hpp material.hpp
